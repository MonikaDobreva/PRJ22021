...
as
select first_conversion.id, flightRoutesView.originAirportCode, flightRoutesView.destinationAirportCode,
...
create or replace view passengersView (passengerID, firstName, lastName, passportNumber,
...
create trigger insert_flight
    instead of insert on flightsView
    for each row
